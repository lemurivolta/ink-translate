...
namespace LemuRivolta.InkTranslate
{
    ...
    public class InkTranslateAsset : ScriptableObject
    {
        ...
        [Tooltip("Whether to skip the content of string variables or not. You can explicitely override this behaviour for singular variables.")]
        public bool SkipStringVariables;

        [Tooltip("Always translate variables in this list. This can override the 'Skip string variables' check.")]
        public List<string> AlwaysTranslatedVariables;

        [Tooltip("Never translate variables in this list. This can override the 'Skip string variables' check.")]
        public List<string> NeverTranslatedVariables;
        ...
        private void OnValidate()
        {
            ...
            // remove duplicates between variables
            RemoveDuplicatesInPlace(AlwaysTranslatedVariables);
            RemoveDuplicatesInPlace(NeverTranslatedVariables);
        }
